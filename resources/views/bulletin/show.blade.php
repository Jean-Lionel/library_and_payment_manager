                ...
                @foreach( $courseCategories ?? [] as $key => $courseCategorie)
                    ...
                    @foreach ($courseCategorie ?? [] as $k => $course)
                        {{-- expr --}}
                         ...
                         @php
                                $interr_trimestre_1 = recuperer_point($eleve_id = $eleve->id ,$cour_id = $course->id, $trimestre_id = 1, $anne_scolaire_id , $type_evaluation = 'INTERROGATION' );
                                $interr_trimestre_2 = recuperer_point($eleve_id = $eleve->id ,$cour_id = $course->id, $trimestre_id = 2, $anne_scolaire_id , $type_evaluation = 'INTERROGATION' );
                                $interr_trimestre_3 = recuperer_point($eleve_id = $eleve->id ,$cour_id = $course->id, $trimestre_id = 3, $anne_scolaire_id , $type_evaluation = 'INTERROGATION' );

                                $examen_trimestre_1 = recuperer_point($eleve_id = $eleve->id ,$cour_id = $course->id, $trimestre_id = 1, $anne_scolaire_id , $type_evaluation = 'EXAMEN' );
                                $examen_trimestre_2 = recuperer_point($eleve_id = $eleve->id ,$cour_id = $course->id, $trimestre_id = 2, $anne_scolaire_id , $type_evaluation = 'EXAMEN' );
                                $examen_trimestre_3 = recuperer_point($eleve_id = $eleve->id ,$cour_id = $course->id, $trimestre_id = 3, $anne_scolaire_id , $type_evaluation = 'EXAMEN' );
