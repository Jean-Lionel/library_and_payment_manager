<div>
    ...
    @if ($open)
        <div class="container pt-5 border px-5 py-5  border-dark bg-white">
            ...
            <button wire:click="$set('open',false)" class="btn btn-sm btn-danger text-white float-right">Fermer <i class="fa fa-close"> </i></button>
            <form wire:submit.prevent="savePatrimoine">
                ...
                @else
                    <button type="submit" class="btn btn-sm btn-primary rounded-0 float-right">ENREGISTRER</button>
                @endif
            </form>
        </div>
    @else
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-danger"
                                    wire:click="$emit('deletePatrimoine',{{ $patrimoine->id }})">Supprimer</button>
                            </td>
